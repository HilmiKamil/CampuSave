      ...
      <form action="{{ route('user.budget.store') }}" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="income_target" placeholder="Masukkan jumlah">
          </div>
          <div class="mb-3">
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('user.budget.update', $currentBudget->id) }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label">Target Pendapatan (Rp)</label>
              <input type="number" class="form-control" name="income_target" 
                    value="{{ $currentBudget->income_target ?? '' }}" placeholder="Masukkan jumlah">
            </div>
            <div class="mb-3">
              <label class="form-label">Batas Pengeluaran (Rp)</label>
